...
public final class MCacheService {
    ...
    private static class MCacheServiceInitializer{
        private static final MCacheService mCacheservice = new MCacheService();
    }

    public static MCacheService getInstance(){
        return MCacheServiceInitializer.mCacheservice;
    }
