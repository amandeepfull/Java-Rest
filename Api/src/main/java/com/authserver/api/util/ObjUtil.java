...
import com.authserver.api.context.ApplicationContextProvider;
...
public final class ObjUtil {
    ...
    private static ObjectMapper mapper = getApplicationContext();
    ...
    private static ObjectMapper getApplicationContext() {
        return ApplicationContextProvider.getApplicationContext().getBean("objectMapper", ObjectMapper.class);
    }
}
